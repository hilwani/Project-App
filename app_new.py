        ...
        if not projects:
            ...
            if selected_project != "Select a project...":
                ...
                if not tasks:
                    ...
                    # Display tasks in a grid of 3 columns
                    cols = st.columns(3)
                    for i, task in enumerate(tasks):
                        ...
                        with col:
                            # Task card container
                            card_class = "task-card task-card-overdue" if is_overdue else "task-card"
                            ...
                            # Buttons container
                            st.markdown('<div class="task-card-buttons">', unsafe_allow_html=True)
                            ...
                            st.markdown('</div>', unsafe_allow_html=True)  # Close task card container
